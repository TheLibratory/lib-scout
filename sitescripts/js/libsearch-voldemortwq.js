...
$(document).ready(function(){
	...
	var helpertext = ["Search for books and other materials in our library catalog", 
			...
			"Search for articles in selected library databases",
			...
			success: function(msg){ 
				$('#search-home-content').hide(); 
	   			$('#search-home-content').show(1, function(event, request, settings){
					...
					if (thisurl == "/sitescripts/search-box/searchbox-form.php?query=catalog"){
					...
					if (thisurl == "/sitescripts/search-box/searchbox-form.php?query=cdsdvds"){
						if (in_array(usertext, helpertext)){
					...
					if (thisurl == "/sitescripts/search-box/searchbox-form.php?query=metalib") {
						if (in_array(usertext, helpertext)){
					...
					if (thisurl == "/sitescripts/search-box/searchbox-form.php?query=voldemort") {
                                                if (in_array(usertext, helpertext)){
                                                        $('#query').attr("value", helpertext[5]);
                                                }
                                                else if (usertext == ""){
					...
					if (thisurl == "/sitescripts/search-box/searchbox-form.php?query=ejournal") {
						if (in_array(usertext, helpertext)){
					...
					if (thisurl == "/sitescripts/search-box/searchbox-form.php?query=site") {
						if (in_array(usertext, helpertext)){
	...
	$('#iiikw').attr('href', '/sitescripts/search-box/searchbox-form.php?query=catalog');
	...
	$('#cdsdvds').attr('href', '/sitescripts/search-box/searchbox-form.php?query=cdsdvds');
	...
	$('#metalib').attr('href', '/sitescripts/search-box/searchbox-form.php?query=metalib');
	$('#metalib').click( function() {
        ...
        $('#voldemort').attr('href', '/sitescripts/search-box/searchbox-form.php?query=voldemort');
	...
	$('#ejournal').attr('href', '/sitescripts/search-box/searchbox-form.php?query=ejournal');
	...
	$('#utlol').attr('href', '/sitescripts/search-box/searchbox-form.php?query=site');
