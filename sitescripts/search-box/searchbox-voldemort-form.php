...
else if ($query=="cdsdvds"){
echo '
<form action="/sitescripts/search-box/searchbox.php" method="get">
        <label for="query" id="querylabel">CDs/DVDs</label>
        <input type="hidden" id="engine" name="engine" value="cddvd" />
        <input type="text" name="query" id="query" title="" value="" />
        <input type="image" src="/graphics/search-box/button-search-up.png" alt="Find" class="find" value="Find" />
       <br />
	<input type="radio" name="subengine" id="search-cd" value="cd" />
        <label for="search-cd" style="display:inline;">CDs</label>
        <input type="radio" name="subengine" id="search-dvd" value="dvd" checked="checked"  />
        <label for="search-dvd" style="display:inline;">DVDs</label>
